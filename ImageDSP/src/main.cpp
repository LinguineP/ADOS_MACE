...
int main(int argc, char *argv[]) {
	...
	parser.addOptions({
		...
		{
			{"i", "in-img"},
			QApplication::translate("main", "input image [*.jpg, *.png, *.bmp...]."),
	...
	if(gui_mode){
        ...
        QImage out_img;//=QImage(in_img.width()*3,in_img.height()*3,QImage::Format_RGB888);
        out_img=out_img.convertToFormat(QImage::Format_RGB888);
        ...
        //std::cout<<parser.value("o").toStdString();
		

        out_img.save(parser.value("o"),nullptr,100);
